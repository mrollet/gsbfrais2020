    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-3">
                <input type="text" name="libelle" value="{{$unFraisHorsForfait->libelle}}" class="form-control" placeholder="Action réalisée" required autofocus>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2 col-sm-2">
                <input type="date" name="date" value="{{$unFraisHorsForfait->date}}"  class="form-control" placeholder="AAAA/MM/JJ" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-3 col-sm-3 control-label">Montant : </label>
            <div class="col-md-2 col-sm-2">
                <input type="text" class="form-control"  name="montant" value="{{$unFraisHorsForfait->montant}}" placeholder="Montant engagé" pattern="^\d*(\.\d{2})?" required>
            </div>
        </div>
        <div class="form-group">
