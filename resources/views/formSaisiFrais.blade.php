...
<div class="col-md-12  col-sm-12 well well-md">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <label class="col-md-3 col-sm-3 control-label">{{$unFrais->libelle}} ({{$unFrais->idfraisforfait}}): </label>
            <div class="col-md-2 col-sm-2">
                <input type="number" name="lesFrais[{{$unFrais->idfraisforfait}}]" value="{{$unFrais->quantite}}" class="form-control" placeholder="quantite" required>
            </div>
        </div>
        @endforeach
         <div class="form-group">
